...
/*
 * For renderers that cannot hand out a GL texture: the display image as
 * XRGB8888, bottom row first like a GL texture. Valid between a call to
 * nv2a_get_framebuffer_surface() that returned 0 and the matching release.
 */
